...
function testCase(options) {
  var testDescription, rootElement, eventSource, eventString, eventChain, modifyFunction,
    assertFunction;
  var isAsync = false;
...
function runBaseTests() {
  px_sample_component_1 = document.getElementById('fixture');

  suite('Base Automation Tests for px-navbar', function() {

    test('Polymer exists', function() {
      assert.isTrue(Polymer !== null);
    });
    test('px-navbar fixture is created', function() {
